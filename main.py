...
if __name__ == "__main__":
    print("Перед работой с программой стоит ознакомиться, с тем как она работает: ")
    print("Для получения информации о разделе нужно написать его название,"
          " а после обратиться к элементу desc, который является описанием")
    print('\n')
    main()
